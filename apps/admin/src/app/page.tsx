                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-muted-foreground">Order #12345 was completed 5 minutes ago</p>
                    </div>
                  </div>
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-muted-foreground">Version 2.1.0 was deployed 1 hour ago</p>
                    </div>
                  </div>
                </div>
              </CardContent>
